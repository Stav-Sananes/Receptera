...
PY_ALLOW="Apache Software License;Apache 2.0;Apache-2.0;Apache License, Version 2.0;Apache-2.0 OR BSD-2-Clause;MIT License;MIT;BSD License;BSD-3-Clause;3-Clause BSD License;BSD-2-Clause;ISC License;ISC;ISC License (ISCL);Python Software Foundation License;PSF-2.0;The Unlicense;Mozilla Public License 2.0 (MPL 2.0);MPL-2.0 AND MIT;MPL-2.0 AND (Apache-2.0 OR MIT);BSD-3-Clause AND 0BSD AND MIT AND Zlib AND CC0-1.0"
